...
async def test_vocamac_headless_warmup_does_not_launch_the_one_shot_cli(
    tmp_path: Path,
) -> None:
    engine, executable = _build_headless_engine(
        tmp_path,
...
async def test_vocamac_without_headless_cli_keeps_the_whisperkit_path(tmp_path: Path) -> None:
